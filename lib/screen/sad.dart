...
import 'package:cool_calm/sub_screen/speak.dart';
...
class random1 extends StatefulWidget {
  ...
  @override _random1State createState() => _random1State();
}
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                SizedBox(height: 20.0,),
                                Text("Notice how you feel and why.",
                                  style: GoogleFonts.montserrat(
                                      color: AppColor.skywhite1,
                                      fontSize: 15.0
                                  ),),
                                SizedBox(height: 20.0,),
                               Text("Put yourself in a good mood",
                                  style: GoogleFonts.montserrat(
                                      color: AppColor.skywhite1,
                                      fontSize: 15.0
                                  ),),
                                ...
                                Padding(
                                  ...
                                  child: Text("Bounce back from disappointments or failures",
                                    style: GoogleFonts.montserrat(
                                        color: AppColor.skywhite1,
                                        fontSize: 15.0
                                    ),),
                          ...
                          //                 child: GestureDetector(
                          //                   onTap: (){
                          //                     Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ScreenTimer5()));
                          //                   },
                          //                   child: Container(
                          //                     height: 250,
                          //                     width: 100,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    SizedBox(height: 5.0,),
                                    Text("Write down 3 things what makes you sad.",
                                      style: GoogleFonts.poppins(
                                          color: AppColor.skywhite1,
                                          fontSize: 10.0
                                      ),
