...
class medState extends State<med> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      //       // GestureDetector(
                      //       //   onTap: (){
                      //       //     Custom(context: context).showSuccessAlertDialog("f", "f");
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text("Find place to sit that feels calm and quiet to you.",
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(12.0),
                          child: Text("You can sit in a chair with your feet on the floor, you can sit loosely cross-legged, you can kneel all are fine. Just make sure you are stable and in a position you can stay in for a while.",
                            style: GoogleFonts.poppins(
                                color: AppColor.skywhite1,
                                fontSize: 14.0
                            ),),
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(12.0),
                          child: Text("Follow the sensation of your breath as it goes in and as it goes out.",
                            style: GoogleFonts.poppins(
                                color: AppColor.skywhite1,
                                fontSize: 14.0
                            ),),
