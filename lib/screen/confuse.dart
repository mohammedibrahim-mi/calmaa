...
import 'package:cool_calm/sub_screen/photo.dart';
...
class random2 extends StatefulWidget {
  ...
  @override _random2State createState() => _random2State();
}
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          //                 child: GestureDetector(
                          //                   onTap: (){
                          //                     Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ScreenTimer6()));
                          //                   },
                          //                   child: Container(
                          //                     height: 250,
                          //                     width: 100,
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 20,),
                                Text("Think Multiple Versions of Reality",
                                  style: GoogleFonts.montserrat(
                                      color: AppColor.black1,
                                      fontSize: 15.0
                                  ),),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    SizedBox(height: 5.0,),
                                    Text("Write down 3  things what makes you confused.",
                                      style: GoogleFonts.poppins(
                                          color: AppColor.skywhite1,
                                          fontSize: 10.0
                                      ),
