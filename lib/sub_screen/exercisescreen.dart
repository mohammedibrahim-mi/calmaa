...
class ScreenTimer3 extends StatefulWidget {
  @override
  ScreenTimer3State createState() => ScreenTimer3State();
}

class ScreenTimer3State extends State<ScreenTimer3> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      Align(
                        alignment: Alignment.topLeft,
                        child: Text("Lengthens attention span,  May help fight addictions,Can decrease blood pressure",
                          style: TextStyle(
                            fontFamily: 'Montserrat',
