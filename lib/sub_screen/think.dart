...
class ScreenTimer7 extends StatefulWidget {
  @override
  ScreenTimer7State createState() => ScreenTimer7State();
}

class ScreenTimer7State extends State<ScreenTimer7> {
